          ...
          function(resultBackend) {
            if (!global.OFFLINE) {
              ...
              generatorUtils.loadTemplateFiles(resultFrontend.value, resultBackend.value, () => {
                ...
                var pathWorkspace = ".skaffolder/template";
                ...
                utils.init(pathWorkspace, data.project, data.modules, data.resources, data.dbs, data.roles);

                // Generate file

                let fileTempalte = generatorBean.parseTemplateFile(pathWorkspace, "openapi.yaml.hbs");
