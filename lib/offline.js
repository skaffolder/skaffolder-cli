var yamlUtils = require("../utils/parseYaml")
...
var createPage = (name) => {
	var skProject = yamlUtils.translateProject(global.logger);
	if (!skProject) { return }
	...
	var page = {
		_id: yamlUtils.getDummyId(name, "page"),
		url: `/${name}`,
		name: name,
		left: 6200,
		top: 5100,
	...
	yamlUtils.generateYaml(skProject, global.logger)
